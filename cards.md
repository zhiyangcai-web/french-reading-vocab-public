...
- 搭配:
  - porter des collants
  - marcher en collants
  - enfiler des collants

例句:

```text
Elle s’est déchaussée, marche en collants.
```
...
- 搭配:
  ...
  - retirer ses gants de caoutchouc
  - une paire de gants en caoutchouc

例句:

```text
Ils tombent sur Lorraine, la mère de Connell, qui retire ses gants de caoutchouc.
```

例句翻译: 他们遇见了洛兰，Connell 的母亲，她正在摘下橡胶手套。

使用场景: 描述家务、清洁、保护手部的用品。
...
- 搭配:
  ...
  - détacher son tablier
  - mettre un tablier

例句:

```text
Lorraine, qui détachait son tablier de cuisine, interrompt son geste.
```

例句翻译: 洛兰正解着厨房围裙，动作停了下来。

使用场景: 描述厨房、家务、手工劳动时的穿着。
...
- 搭配:
  - lécher la cuillère
  - faire tourner la cuillère dans le pot
  - une petite cuillère

例句:

```text
Il s’adosse contre le réfrigérateur et la regarde lécher la cuillère.
```
...
```text
Elle porte de hideuses chaussures plates à semelles épaisses.
```

例句翻译: 她穿着一双难看的平底鞋，鞋底很厚。

使用场景: 描述鞋子、穿着、外貌细节。

### 6. un nœud de cravate
...
- 搭配:
  ...
  - resserrer son nœud de cravate

例句:

```text
Elle le retient après le cours, parfois pour discuter de ce qu’il veut faire dans la vie, et a même une fois touché le nœud de cravate de son uniforme.
```

例句翻译: 她下课后把他留下来，有时是为了讨论他将来想做什么，甚至有一次还碰了他校服领带的结。
...
```text
Lorraine plie soigneusement les gants de caoutchouc et les range sous l’évier.
```

例句翻译: 洛兰仔细叠好橡胶手套，把它们收在水槽下面。
...
- 搭配:
  ...
  - poser quelque chose sur la paillasse

例句:

```text
Marianne s’assoit d’un bond sur la paillasse.
```
...
- 搭配:
  ...
  - sortir les vêtements du sèche-linge

例句:

```text
Il faut juste que j’aille vider le sèche-linge.
```
...
```text
On sait que Marianne habite le manoir blanc avec une grande allée.
```

例句翻译: 大家都知道玛丽安住在那座有一条大车道的白色庄园里。
...
- 搭配:
  ...
  - frotter quelque chose dans le lavabo
  - nettoyer le lavabo

例句:

```text
Elle était allée aux toilettes des filles retirer son chemisier pour le frotter dans le lavabo.
```

例句翻译: 她去了女生厕所脱下衬衣，把它放在洗手池里搓洗。

使用场景: 描述洗手间、清洗衣物、生活场景。
...
```text
Il enfonce le bout de sa chaussure dans une rainure entre les dalles du carrelage.
```
...
- 搭配:
  ...
  - répondre d’un hochement de tête

例句:

```text
Il hoche la tête, regarde autour de lui.
```

例句翻译: 他点点头，环顾四周。

使用场景: 叙述人物反应、沉默回答或尴尬场景。
...
- 搭配:
  - scruter les pages
  - scruter le visage de quelqu’un
  - scruter l’horizon

例句:

```text
En cours, il est trop gêné et agacé pour se concentrer sur la leçon, il scrute les pages de son manuel.
```

例句翻译: 上课时，他太尴尬又烦躁，无法专心听课，只能盯着课本页看。
...
使用场景: 安慰别人、表达负罪感、讨论心理压力。

### 2. mettre quelqu’un dans une position inconfortable
...
```text
Ça le mettrait sans aucun doute dans une position inconfortable.
```

例句翻译: 那毫无疑问会让他处在一种很不舒服的境地。

使用场景: 描述社交尴尬、公开压力、人际关系中的不自在。

### 3. se délecter de quelque chose
...
- 搭配:
  ...
  - se délecter d’un malaise
  - se délecter de petits drames

例句:

```text
C’est généralement le genre de trucs dont elle se délecte.
```

例句翻译: 这通常正是她会乐在其中的那类事情。

使用场景: 描述某人享受八卦、尴尬场面或某种乐趣。

### 4. à l’égard de quelqu’un
...
- 搭配:
  ...
  - son attitude à l’égard de quelqu’un
  - être dur à l’égard de quelqu’un

例句:

```text
Les sentiments qu’il éprouve à son égard sont au centre de toutes les conversations au lycée.
```

例句翻译: 他对她的感情成了学校里所有谈话的中心。

使用场景: 描述态度、感情、评价对象；写作中很实用。
...
- 搭配:
  - être gêné
  - être trop gêné pour parler
  - se sentir gêné

例句:

```text
En cours, il est trop gêné et agacé pour se concentrer sur la leçon.
```

例句翻译: 上课时，他太尴尬又烦躁，无法专心听课。

使用场景: 描述社交尴尬、羞怯、被困住的心理状态。
...
例句翻译: 所有人都那么确信他被 Neary 小姐吸引，以至于他有时也怀疑自己的内心冲动。
...
```text
Il paraît qu’elle ne se rase pas les jambes.
```
...
```text
Elle pouvait voir à travers les yeux de Connell, jusqu’au fond de son crâne.
```
...
- 搭配:
  - renverser un verre
  - renverser de la glace
  - renverser quelque chose sur ses vêtements

例句:

```text
Connell a entendu dire qu’elle avait renversé de la glace au chocolat sur ses vêtements au réfectoire du lycée.
```

例句翻译: Connell 听说她把巧克力冰淇淋洒在了自己衣服上，就在学校食堂。

使用场景: 描述小事故、弄脏衣服、打翻饮料。
...
- 搭配:
  ...
  - enfoncer une clé dans la serrure
...
```text
Elle avait renversé de la glace au chocolat sur ses vêtements au réfectoire du lycée.
```

例句翻译: 她曾把巧克力冰淇淋洒在自己衣服上，地点是学校食堂。

使用场景: 描述学校、寄宿制或集体生活里的用餐地点。
...
```text
Si elle voulait, elle pourrait ouvertement saluer Connell au bahut.
```

例句翻译: 如果她愿意，她完全可以在学校公开跟 Connell 打招呼。

使用场景: 口语里谈学校生活；正式写作慎用。
...
- 搭配:
  - cet aprèm
  - à cet aprèm
  - passer l’aprèm avec quelqu’un

例句:

```text
À cet aprèm, pourrait-elle lui dire devant tout le monde.
```

例句翻译: “下午见，”她也许可以当着所有人的面对他说。

使用场景: 口语聊天、短信、非正式叙述。

### 4. solliciter quelqu’un
...
```text
Il reste assis en silence pendant qu’elle lui parle et le sollicite.
```

例句翻译: 她跟他说话、想引起他的回应时，他一直沉默地坐着。
...
例句翻译: 如果在某种程度上，在他自己的感知之外或还没达到他能察觉的范围，她真的吸引着他呢？
...
例句翻译: 他甚至不知道，当某个人吸引我们时，我们按理应该感受到什么。
